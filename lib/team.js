...
var team = [
    ...
    member('jdoe', 'John', 'Doe', 'senior', "Hi I'm John Doe. I like to do the dance called the DoDo"),
    // Addition of team members
    member('dhnguyen', 'David', 'Nguyen', 'senior',
      'Hi, I\'m David. I am currently a senior at UMass Amherst pursuing a degree in Computer Science. I enjoy doing a lot of things in my free time such as playing video games, basketball, and watching anime. For our project, I will be working on the front end development.'),
    ...
    member('jinhuiliang', 'Evans', 'Liang', 'junior',
      'Hi, I\'m Evans, currently a junior at umass. Over the summer I worked at a start up and have experiences in front end, I designed parts of an internal app for the company and also implemented a few UI as well as some data mining. I created various scripts to scrape data off from websites. And so for this project I will mostly focus on the front end and also contribute to database maintainence since I have some knowledge in that as well'),
